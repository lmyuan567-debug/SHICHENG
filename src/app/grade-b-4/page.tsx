      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-700">
            Average condition with noticeable signs of use. May have moderate scratches, scuffs, dings, or minor dents. Screen may have visible scratches. All functions work perfectly.
          </p>
        </div>
